...
function handleDialogFlowAction(sender, action, messages, contexts, parameters) {
    ...
    switch (action) {
        ...
        case "Adres_type.Adres_type-next":
        console.log("TUTAJ CONTEXTS" + parameters.fields['geo-city'].stringValue + "typ-miejsca-nazwa:" + parameters.fields['typ-miejsca-nazwa'].stringValue + "Nazwa ulicy" + parameters.fields['nazwa-ulicy'].stringValue)
...
function handleDialogFlowResponse(sender, response) {
    ...
    console.log("HEaaaaa" + JSON.stringify(response));
